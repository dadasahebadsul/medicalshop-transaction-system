...
public class update_id_frame implements ActionListener {
	...
	public static void update(String id) {
		// TODO Auto-generated method stub
                 update_id_frame obj=new update_id_frame();
	}
	update_id_frame()
	{
		f1=new JFrame();
        ...
        l1=new JLabel("Update Medicine Record");
        ...
        tf3=new JTextField();
        tf3.setBounds(150,160,250,25);
		f1.add(tf3);
		
		l5=new JLabel("Price :-");
    	l5.setBounds(30,200,90,30);
    	l5.setFont (new Font("Arial",Font.BOLD,20));
        f1.add(l5);
        
        tf4=new JTextField();
        tf4.setBounds(150,200,250,25);
		f1.add(tf4);
        ...
        dc1 = new JDateChooser();
            ...
            dc2 = new JDateChooser();
      		dc2.setBounds(150,320,180,30);
      		dc2.setForeground(new Color(105, 105, 105));
      		f1.add(dc2); 
      		
      		
      		 b1=new JButton("UPDATE");
             b1.setBounds(80,380,150,25);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(ob==b1)
		{
			...
			UpdateDatabaseRecords.update(tf1.getText(),tf2.getText(),tf3.getText(),tf4.getText(),tf5.getText(),str,stri); 
